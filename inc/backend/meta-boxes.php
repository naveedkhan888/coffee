 ...
 */
function coffeee_register_meta_boxes( $meta_boxes ) {
	
	// Post format's meta box
	$meta_boxes[] = array(
		'id'       => 'format_detail',
		'title'    => esc_html__( 'Format Details', 'coffeee' ),
		'pages'    => array( 'post' ),
		'context'  => 'normal',
		'priority' => 'high',
		'autosave' => true,
		'fields'   => array(
			...
			array(
				'name'  => esc_html__( 'Gallery', 'coffeee' ),
				'id'    => 'post_gallery',
				'type'  => 'image_advanced',
				'class' => 'gallery',
				// Image size that displays in the edit page. Possible sizes small,medium,large,original
			...
			array(
				'name'  => esc_html__( 'Background Video', 'coffeee' ),
				'id'    => 'bg_video',
				'type'  => 'image_advanced',
				'class' => 'video',
				'max_file_uploads' => 1,
			...
			array(
				'name'  => esc_html__( 'Text Link', 'coffeee' ),
				'id'    => 'text_link',
				'type'  => 'textarea',
				'cols'  => 20,
				'rows'  => 2,
			...
			array(
				'name'  => esc_html__( 'Quote', 'coffeee' ),
				'id'    => 'post_quote',
				'type'  => 'textarea',
				'class' => 'quote',
			),
			array(
				'name'  => esc_html__( 'Quote Name', 'coffeee' ),
				'id'    => 'quote_name',
				'type'  => 'text',
				'class' => 'quote',
			)		
	...
	$meta_boxes[] = array(
		'id'       => 'page-settings',
		'title'    => esc_html__( 'Page Header Settings', 'coffeee' ),
		'pages'    => array( 'page' ),
		'context'  => 'normal',
		'priority' => 'high',
		'autosave' => true,
		'fields'   => array(
            array(
                'id'        => 'page_layout',
                'name'      => esc_html__( 'Page Layout', 'coffeee' ),
                'type'      => 'image_select',
                'options'   => array(
            ...
            array(
                'name'             => esc_html__( 'Page Header On/Off', 'coffeee' ),
                'id'               => 'pheader_switch',
                'type'             => 'switch',
                'style'            => 'rounded',
                'on_label'         => 'On',
            ...
            array(
                'name'             => esc_html__( 'Background Page Header', 'coffeee' ),
                'id'               => 'pheader_bg_image',
                'type'             => 'image_advanced',
                'max_file_uploads' => 1,
            )
	...
	$meta_boxes[] = array (
      	...
      	'fields' =>   array (  
			...
			array(
                'name'             => esc_html__( 'Header Transparent?', 'coffeee' ),
                'id'               => 'is_trans',
				'type'             => 'select',
				'options'   => array(
                    'default'   => 'Default',
	...
	$meta_boxes[] = array(
        'id'       => 'case-settings',
        'title'    => esc_html__( 'Project Settings', 'coffeee' ),
        'pages'    => array( 'xp_portfolio' ),
        'context'  => 'normal',
        'priority' => 'high',
        'autosave' => true,
        'fields'   => array(
            array(
                'name'             => esc_html__( 'Carousel Image', 'coffeee' ),
                'id'               => 'slide_img',
                'type'             => 'image_advanced',
                'max_file_uploads' => 1,
            ),
    ...
    $meta_boxes[] = array(
        'id'       => 'pthumb-settings',
        'title'    => esc_html__( 'Thumbnail Image Settings', 'coffeee' ),
        'pages'    => array( 'xp_portfolio' ),
        'context'  => 'normal',
        'priority' => 'high',
        'autosave' => true,
        'fields'   => array(
            array(
                'id'        => 'thumb_size',
                'name'      => esc_html__( 'Select Size', 'coffeee' ),
                'type'      => 'select',
                'options'   => array(
                    'normal' 	=> 'Normal Width',
...
add_filter( 'rwmb_meta_boxes', 'coffeee_register_meta_boxes' );