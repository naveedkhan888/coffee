 ...
 * Widget Name: Team 1
 */
class Coffeee_Team extends Widget_Base{
	...
	protected function register_controls() {
		...
		$this->start_controls_section(
			'content_section',
			[
				'label' => esc_html__( 'Member Team', 'coffeee' ),
			]
		);
		...
		$repeater->add_control(
		    ...
		    [
		        ...
		        'default' => esc_html__( 'Social', 'coffeee' ),
		    ]
	    );
		...
		$this->add_control(
		    ...
		    [
		        ...
		        'default'     => [
		            [
		             	'title'       => esc_html__( 'Twitter', 'coffeee' ),
		                'social_link' => esc_html__( 'https://www.twitter.com/', 'coffeee' ),
		                'social_icon' => [
							'value' => 'fab fa-twitter',
							'library' => 'fa-brand',
						],
		            ...
		            [
		             	'title'       => esc_html__( 'Facebook', 'coffeee' ),
		                'social_link' => esc_html__( 'https://www.facebook.com/', 'coffeee' ),
		                'social_icon' => [
		            ...
		            [
		             	'title'       => esc_html__( 'Pinterest', 'coffeee' ),
		                'social_link' => esc_html__( 'https://www.pinterest.com/', 'coffeee' ),
		                'social_icon' => [
		...
		$this->add_control(
			'bg_box',
			[
				'label' => __( 'Background Box', 'coffeee' ),
		...
		$this->add_control(
			'box_animation',
			[
				'label' => __( 'Hover Animation', 'coffeee' ),
		...
		$this->add_control(
			'bg_hover_des_color',
			[
				'label' => __( 'Extra/Job Color', 'coffeee' ),
				'type' => Controls_Manager::COLOR,
				'default' => '',
				'selectors' => [
		...
		$this->add_control(
			'plus_color',
			[
				'label'     => esc_html__( 'Plus Color', 'coffeee' ),
				'type'      => Controls_Manager::COLOR,
				'default'   => '',
				'selectors' => [
		...
		$this->add_control(
			'plus_bg',
			[
				'label'     => esc_html__( 'Plus Background', 'coffeee' ),
				'type'      => Controls_Manager::COLOR,
				'default'   => '',
				'selectors' => [
...
// After the Coffeee_Team class is defined, I must register the new widget class with Elementor:
Plugin::instance()->widgets_manager->register( new Coffeee_Team() );