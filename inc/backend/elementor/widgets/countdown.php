 ...
 */
class Coffeee_CountDown extends Widget_Base{
	...
	public function get_title() {
		return __( 'XP CountDown', 'coffeee' );
	}
	...
	protected function register_controls() {
		...
		$this->add_control(
			...
			[
				...
				'default' => __( '2025-10-26 12:00', 'coffeee' ),
			]
		);
		...
		$this->add_control(
			'zone',
			[
				'label' => __( 'UTC Timezone Offset', 'coffeee' ),
				'type' => Controls_Manager::NUMBER,
				'default' => __( '0', 'coffeee' ),
			]
		);
		...
		$this->start_controls_tab(
			'tab_title_normal',
			[
				'label' => __( 'One', 'coffeee' ),
			]
		);
		$this->add_control(
			'day',
			[
				'label' => __( 'Day', 'coffeee' ),
				'type' => Controls_Manager::TEXT,
				'default' => __( 'Day', 'coffeee' ),
			]
		);
		$this->add_control(
			'hour',
			[
				'label' => __( 'Hour', 'coffeee' ),
				'type' => Controls_Manager::TEXT,
				'default' => __( 'Hour', 'coffeee' ),
			]
		);
		$this->add_control(
			'min',
			[
				'label' => __( 'Minute', 'coffeee' ),
				'type' => Controls_Manager::TEXT,
				'default' => __( 'Minute', 'coffeee' ),
			]
		);
		$this->add_control(
			'second',
			[
				'label' => __( 'Second', 'coffeee' ),
				'type' => Controls_Manager::TEXT,
				'default' => __( 'Second', 'coffeee' ),
			]
		);
		...
		$this->start_controls_tab(
			'tab_title_active',
			[
				'label' => __( 'Multi', 'coffeee' ),
			]
		);
		$this->add_control(
			'days',
			[
				'label' => __( 'Days', 'coffeee' ),
				'type' => Controls_Manager::TEXT,
				'default' => __( 'Days', 'coffeee' ),
			]
		);
		$this->add_control(
			'hours',
			[
				'label' => __( 'Hours', 'coffeee' ),
				'type' => Controls_Manager::TEXT,
				'default' => __( 'Hours', 'coffeee' ),
			]
		);
		$this->add_control(
			'mins',
			[
				'label' => __( 'Minutes', 'coffeee' ),
				'type' => Controls_Manager::TEXT,
				'default' => __( 'Minutes', 'coffeee' ),
			]
		);
		$this->add_control(
			'seconds',
			[
				'label' => __( 'Seconds', 'coffeee' ),
				'type' => Controls_Manager::TEXT,
				'default' => __( 'Seconds', 'coffeee' ),
			]
		);
...
// After the Coffeee_CountDown class is defined, I must register the new widget class with Elementor:
Plugin::instance()->widgets_manager->register( new Coffeee_CountDown() );