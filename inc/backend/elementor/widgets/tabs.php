 ...
 * Widget Name: Tabs
 */
class Coffeee_Tabs extends Widget_Base{
	...
	protected function register_controls() {
		...
		$repeater->add_control(
			'tab_title',
			[
				'label' => __( 'Title & Description', 'coffeee' ),
				'type' => Controls_Manager::TEXT,
				'default' => __( 'Tab Title', 'coffeee' ),
				'placeholder' => __( 'Tab Title', 'coffeee' ),
				'label_block' => true,
			]
		);
		...
		$repeater->add_control(
			...
			[
				...
				'default' => __( 'Tab Content', 'coffeee' ),
				'placeholder' => __( 'Tab Content', 'coffeee' ),
		...
		$this->add_control(
			'xp_tabs',
			[
				'label' => __( 'Tabs Items', 'coffeee' ),
				'type' => Controls_Manager::REPEATER,
				'fields' => $repeater->get_controls(),
				'default' => [
					[
						'tab_title' => __( 'Tab #1', 'coffeee' ),
						'tab_content' => __( 'We help ambitious businesses like yours generate more profits by building awareness, driving web traffic, connecting with customers, and growing overall sales. Give us a call.', 'coffeee' ),
					],
					[
						'tab_title' => __( 'Tab #2', 'coffeee' ),
						'tab_content' => __( 'We help ambitious businesses like yours generate more profits by building awareness, driving web traffic, connecting with customers, and growing overall sales. Give us a call.', 'coffeee' ),
					],
				],
...
// After the Coffeee_Tabs class is defined, I must register the new widget class with Elementor:
Plugin::instance()->widgets_manager->register( new Coffeee_Tabs() );