 ...
 */
class Coffeee_Progress_Bars extends Widget_Base{
	...
	public function get_title() {
		return __( 'XP Progress Bars', 'coffeee' );
	}
	...
	protected function register_controls() {
		...
		$this->add_control(
			'bar_style',
			[
				'label' 	=> __( 'Bar Style', 'coffeee' ),
				'type'  	=> Controls_Manager::SELECT,
				'default' 	=> 'line',
				'options' 	=> [
					'line'    => __( 'Style 1: Line', 'coffeee' ),
					'circle'  => __( 'Style 2: Circle', 'coffeee' ),
				]
			]
		);
		...
		$this->add_control(
			...
			[
				...
				'default' => __( 'Keyword Research', 'coffeee' ),
			]
		);
		$this->add_control(
			'percent',
		...
		$this->add_control(
			'percent_text',
			[
				'label'   => esc_html__( 'Show Percent Text', 'coffeee' ),
...
// After the Coffeee_Progress_Bars class is defined, I must register the new widget class with Elementor:
Plugin::instance()->widgets_manager->register( new Coffeee_Progress_Bars() );