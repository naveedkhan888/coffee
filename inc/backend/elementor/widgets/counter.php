 ...
 * Widget Name: Counter
 */
class Coffeee_Counter extends Widget_Base{
	...
	public function get_title() {
		return __( 'XP Counter 1', 'coffeee' );
	}
	...
	protected function register_controls() {
		...
		$this->start_controls_section(
			'content_section',
			[
				'label' => __( 'Counter', 'coffeee' ),
			]
		);
		$this->add_control(
			'pos_num',
			[
				'label' => __( 'Number Position', 'coffeee' ),
		...
		$this->add_control(
			...
			[
				...
				'default' => __( 'Current Clients', 'coffeee' ),
			]
		);
...
// After the Coffeee_Counter class is defined, I must register the new widget class with Elementor:
Plugin::instance()->widgets_manager->register( new Coffeee_Counter() );