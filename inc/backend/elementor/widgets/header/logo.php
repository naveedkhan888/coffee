 ...
 * Widget Name: Logo
 */
class Coffeee_Logo extends Widget_Base{
	...
	protected function register_controls() {
		...
		$this->add_control(
			'logo_image',
			 [
				'label' => esc_html__( 'Image', 'coffeee' ),
...
// After the Coffeee_Logo class is defined, I must register the new widget class with Elementor:
Plugin::instance()->widgets_manager->register( new Coffeee_Logo() );