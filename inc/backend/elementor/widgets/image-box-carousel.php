 ...
 */
class Coffeee_Image_Box_Carousel extends Widget_Base{
	...
	public function get_title() {
		return __( 'XP Image Box Carousel', 'coffeee' );
	}
	...
	protected function register_controls() {
		...
		$this->add_control(
			...
			[
				...
				'default' => __( 'Explore More', 'coffeee' ),
				'label_block' => true
			]
		);
...
// After the Coffeee_Image_Box_Carousel class is defined, I must register the new widget class with Elementor:
Plugin::instance()->widgets_manager->register( new Coffeee_Image_Box_Carousel() );