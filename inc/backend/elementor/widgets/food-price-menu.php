...
class Food_Price_Menu_Widget extends Widget_Base {
    ...
    public function get_title() {
        return __( 'Food Price Menu', 'coffeee' );
    }
    ...
    protected function register_controls() {
        ...
        $repeater->add_control(
            ...
            [
                ...
                'default' => __( 'Menu Item Description' , 'coffeee' ),
                'show_label' => true,
            ]
        );
        ...
        $repeater->add_control(
            'description_tag',
            [
                'label' => __( 'Description HTML Tag', 'coffeee' ),
                'type' => Controls_Manager::SELECT,
                'default' => 'p',
                'options' => [
                    'h1' => __( 'H1', 'coffeee' ),
        ...
        $this->add_control(
            'list',
            [
                'label' => __( 'List Items', 'coffeee' ),
                'type' => Controls_Manager::REPEATER,
                'fields' => $repeater->get_controls(),
                'default' => [
                    [
                        'title' => __( 'Menu Item #1', 'coffeee' ),
                        'description' => __( 'Description for menu item #1', 'coffeee' ),
                        'price' => __( '$10', 'coffeee' ),
                    ],
                ],
                'title_field' => '{{{ title }}}',
        ...
        $this->add_group_control(
            ...
            [
                ...
                'label' => __( 'Title Typography', 'coffeee' ),
        ...
        $this->add_control(
            'description_color',
            [
                'label' => __( 'Description Color', 'coffeee' ),
                'type' => Controls_Manager::COLOR,
                'selectors' => [
        ...
        $this->add_group_control(
            ...
            [
                ...
                'label' => __( 'Description Typography', 'coffeee' ),
        ...
        $this->add_group_control(
            ...
            [
                ...
                'label' => __( 'Price Typography', 'coffeee' ),
        ...
        $this->add_control(
            'separator_style',
            [
                'label' => __( 'Separator Style', 'coffeee' ),
                'type' => Controls_Manager::SELECT,
                'options' => [
                    'solid' => __( 'Solid', 'coffeee' ),
                    'dotted' => __( 'Dotted', 'coffeee' ),
                    'dashed' => __( 'Dashed', 'coffeee' ),
                    'double' => __( 'Double', 'coffeee' ),
                    'none' => __( 'None', 'coffeee' ),
                ],
                'default' => 'solid',
                'selectors' => [
        ...
        $this->add_control(
            'separator_weight',
            [
                'label' => __( 'Separator Weight', 'coffeee' ),
        ...
        $this->add_control(
            'separator_color',
            [
                'label' => __( 'Separator Color', 'coffeee' ),
                'type' => Controls_Manager::COLOR,
                'selectors' => [
        ...
        $this->add_control(
            ...
            [
                'label' => __( 'Item Separator Style', 'coffeee' ),
                'type' => Controls_Manager::SELECT,
                'options' => [
                    'solid' => __( 'Solid', 'coffeee' ),
                    'dotted' => __( 'Dotted', 'coffeee' ),
        ...
        $this->add_control(
            ...
            [
                'label' => __( 'Item Separator Weight', 'coffeee' ),
                'type' => Controls_Manager::SLIDER,
                'range' => [
                    'px' => [
                        'min' => 1,
        ...
        $this->add_control(
            ...
            [
                'label' => __( 'Item Separator Color', 'coffeee' ),
                'type' => Controls_Manager::COLOR,
                'selectors' => [
