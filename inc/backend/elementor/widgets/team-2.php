 ...
 * Widget Name: Team 2
 */
class Coffeee_Team2 extends Widget_Base{
...
// After the Coffeee_Team2 class is defined, I must register the new widget class with Elementor:
Plugin::instance()->widgets_manager->register( new Coffeee_Team2() );