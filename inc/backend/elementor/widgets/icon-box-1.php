 ...
 */
class Coffeee_IconBox1 extends Widget_Base{
	...
	public function get_title() {
		return __( 'XP Icon Box 1', 'coffeee' );
	}
	...
	protected function register_controls() {
		...
		$this->add_control(
			...
			[
				...
				'type' => Controls_Manager::TEXTAREA,
				'default' => __( '<i class="xp-webicon-trajectory"></i> Learn More', 'coffeee' ),
				'condition' => [
					'link[url]!' => '',
				]
			]
		...
		$this->add_control(
			'hover_dark',
			[
				'label'   => esc_html__( 'Dark Style', 'coffeee' ),
				'type'    => Controls_Manager::SWITCHER,
		...
		$this->add_control(
			'heading_hcircle',
			[
				'label' => __( 'Border Circle', 'coffeee' ),
		...
		$this->add_control(
			'is_border',
			[
				'label'   => esc_html__( 'Border Circle', 'coffeee' ),
				'type'    => Controls_Manager::SWITCHER,
...
// After the Coffeee_IconBox1 class is defined, I must register the new widget class with Elementor:
Plugin::instance()->widgets_manager->register( new Coffeee_IconBox1() );