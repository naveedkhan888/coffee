 ...
 */
class Coffeee_Testimonials2 extends Widget_Base{
	...
	public function get_title() {
		return __( 'XP Testimonial Carousel 2', 'coffeee' );
	}
	...
	protected function register_controls() {
		...
		$this->add_control(
		    ...
		    [
		        ...
		        'default'     => [
		            [
		             	'tcontent' => __( '"I am so happy, my dear friend, so absorbed in the exquisite sense of mere tranquil existence, that I neglect my talents. I should be incapable of drawing a single stroke at the present moment."', 'coffeee' ),
		                'timage'  => [
							'url' => get_template_directory_uri().'/images/avatar-1.png',
						],
						'tname'	  => 'Oliver Simson',
		...
		$this->add_control(
			'arrow_align',
			[
				'label' => __( 'Arrows Align', 'coffeee' ),
				'type' => Controls_Manager::SELECT,
				'options' => [
					'middle'   => __( 'Middle', 'coffeee' ),
					'bottom'   => __( 'Bottom', 'coffeee' ),
				],
				'default' => 'middle',
				'prefix_class' => 'arrows-',
				'condition' => [
		...
		$this->add_control(
			'dots_style',
			[
				'label' => __( 'Dots Style', 'coffeee' ),
				'type' => Controls_Manager::CHOOSE,
				'options' => [
					'vertical'   => [
						'title' => esc_html__( 'Vertical', 'coffeee' ),
						'icon'  => 'fa fa-ellipsis-v',
					],
					'horizontal' => [
						'title' => esc_html__( 'Horizontal', 'coffeee' ),
		...
		$this->add_control(
			'quote_bg',
			[
				'label' => __( 'Icon Background', 'coffeee' ),
				'type' => Controls_Manager::COLOR,
				'default' => '',
				'selectors' => [
...
Plugin::instance()->widgets_manager->register( new Coffeee_Testimonials2() );