			...
			<a href="<?php the_permalink(); ?>">
				<?php
					if ( has_post_thumbnail() ) {
						if( $thumb == 'double_w' ){
							the_post_thumbnail( 'coffeee-portfolio-thumbnail-grid-wdouble' );
						}elseif( $thumb == 'double_wh' ){
							the_post_thumbnail( 'coffeee-portfolio-thumbnail-grid-whdouble' );
						}else{
							the_post_thumbnail( 'coffeee-portfolio-thumbnail-grid' );
						}
					}
				?>
			</a>
